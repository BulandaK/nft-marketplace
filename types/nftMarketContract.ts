...
export interface NftMarketContractEventsContext {
  Approval(...parameters: unknown[]): EventFilter;
  ApprovalForAll(...parameters: unknown[]): EventFilter;
  BatchMetadataUpdate(...parameters: unknown[]): EventFilter;
  MetadataUpdate(...parameters: unknown[]): EventFilter;
  NftItemCreated(...parameters: unknown[]): EventFilter;
  OwnershipTransferred(...parameters: unknown[]): EventFilter;
  Transfer(...parameters: unknown[]): EventFilter;
}
